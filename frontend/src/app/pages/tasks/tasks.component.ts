...
export class TasksComponent implements OnInit {
  ...
  // --- Default Fallback Mock Tasks (dates are DYNAMIC, relative to today) ---
  private get defaultMockTasks(): TaskItem[] {
    return [
      {
        id: 1, title: 'Làm báo cáo UML', desc: 'Hoàn thành sơ đồ Use Case, Class Diagram',
        tag: 'PTPM', tagClass: 'bg-purple-100 text-purple-700',
        priority: 'Cao', priorityClass: 'bg-rose-100 text-rose-600',
        dueDate: this.getRelativeDate(2), dueWarning: 'Còn 2 ngày', warnClass: 'text-red-500 font-medium',
        status: 'Cần thực hiện', statusClass: 'bg-blue-50 text-blue-600 font-semibold',
        progress: 0, progressColor: '#5B4DFF'
      },
      {
        id: 2, title: 'Ôn tập Java OOP', desc: 'Ôn tập các kiến thức OOP trong Java',
        tag: 'Java', tagClass: 'bg-emerald-100 text-emerald-700',
        priority: 'Trung bình', priorityClass: 'bg-amber-100 text-amber-600',
        dueDate: this.getRelativeDate(0), dueWarning: 'Hôm nay', warnClass: 'text-amber-500 font-medium',
        status: 'Đang thực hiện', statusClass: 'bg-amber-50 text-amber-600 font-semibold',
        progress: 40, progressColor: '#f59e0b'
      },
      {
        id: 3, title: 'Bài tập thiết kế CSDL', desc: 'Hoàn thành bài tập tuần 2',
        tag: 'Cơ sở dữ liệu', tagClass: 'bg-blue-100 text-blue-700',
        priority: 'Cao', priorityClass: 'bg-rose-100 text-rose-600',
        dueDate: this.getRelativeDate(-3), dueWarning: 'Quá hạn', warnClass: 'text-red-600 font-bold',
        status: 'Đang thực hiện', statusClass: 'bg-amber-50 text-amber-600 font-semibold',
        progress: 60, progressColor: '#5B4DFF'
      },
      {
        id: 4, title: 'Đọc tài liệu ReactJS', desc: 'Đọc và ghi chú Chapter 4, 5',
        tag: 'Web', tagClass: 'bg-sky-100 text-sky-700',
        priority: 'Thấp', priorityClass: 'bg-emerald-100 text-emerald-600',
        dueDate: this.getRelativeDate(7), dueWarning: 'Còn 7 ngày', warnClass: 'text-gray-400',
        status: 'Cần thực hiện', statusClass: 'bg-blue-50 text-blue-600 font-semibold',
        progress: 10, progressColor: '#5B4DFF'
      },
      {
        id: 5, title: 'Chuẩn bị thuyết trình', desc: 'Slide báo cáo đồ án',
        tag: 'PTPM', tagClass: 'bg-purple-100 text-purple-700',
        priority: 'Cao', priorityClass: 'bg-rose-100 text-rose-600',
        dueDate: this.getRelativeDate(4), dueWarning: 'Còn 4 ngày', warnClass: 'text-orange-500 font-medium',
        status: 'Cần thực hiện', statusClass: 'bg-blue-50 text-blue-600 font-semibold',
        progress: 0, progressColor: '#5B4DFF'
      },
      {
        id: 6, title: 'Nộp bài tập tuần 1', desc: 'Cấu trúc dữ liệu',
        tag: 'Cấu trúc dữ liệu', tagClass: 'bg-pink-100 text-pink-700',
        priority: 'Thấp', priorityClass: 'bg-emerald-100 text-emerald-600',
        dueDate: this.getRelativeDate(-10), dueWarning: 'Đã hoàn thành', warnClass: 'text-emerald-600 font-medium',
        status: 'Hoàn thành', statusClass: 'bg-emerald-50 text-emerald-600 font-semibold',
        progress: 100, progressColor: '#10b981'
      },
      {
        id: 7, title: 'Làm slide bài thuyết trình', desc: 'Kỹ năng thuyết trình',
        tag: 'Kỹ năng', tagClass: 'bg-indigo-100 text-indigo-700',
        priority: 'Trung bình', priorityClass: 'bg-amber-100 text-amber-600',
        dueDate: this.getRelativeDate(-14), dueWarning: 'Đã hoàn thành', warnClass: 'text-emerald-600 font-medium',
        status: 'Hoàn thành', statusClass: 'bg-emerald-50 text-emerald-600 font-semibold',
        progress: 100, progressColor: '#10b981'
      },
      {
        id: 8, title: 'Đọc chương 1-3 sách Clean Code', desc: 'Kỹ năng lập trình',
        tag: 'Kỹ năng', tagClass: 'bg-indigo-100 text-indigo-700',
        priority: 'Thấp', priorityClass: 'bg-emerald-100 text-emerald-600',
        dueDate: this.getRelativeDate(-20), dueWarning: 'Đã hoàn thành', warnClass: 'text-emerald-600 font-medium',
        status: 'Hoàn thành', statusClass: 'bg-emerald-50 text-emerald-600 font-semibold',
        progress: 100, progressColor: '#10b981'
      }
    ];
  ...
  private get defaultKanbanTodo(): KanbanItem[] {
    return [
      { id: 1, title: 'Làm báo cáo UML', tag: 'PTPM', tagClass: 'bg-purple-100 text-purple-700', due: this.getRelativeDate(2), priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' },
      { id: 2, title: 'Ôn tập Java OOP', tag: 'Java', tagClass: 'bg-emerald-100 text-emerald-700', due: this.getRelativeDate(0), priority: 'Trung bình', pClass: 'bg-amber-100 text-amber-600' },
      { id: 3, title: 'Đọc tài liệu ReactJS', tag: 'Web', tagClass: 'bg-sky-100 text-sky-700', due: this.getRelativeDate(7), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' },
      { id: 4, title: 'Chuẩn bị thuyết trình', tag: 'PTPM', tagClass: 'bg-purple-100 text-purple-700', due: this.getRelativeDate(4), priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' },
      { id: 5, title: 'Nộp bài tập tuần 2', tag: 'Cấu trúc dữ liệu', tagClass: 'bg-pink-100 text-pink-700', due: this.getRelativeDate(-2), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' }
    ];
  }

  private get defaultKanbanInProgress(): KanbanItem[] {
    return [
      { id: 6, title: 'Bài tập thiết kế CSDL', tag: 'Cơ sở dữ liệu', tagClass: 'bg-blue-100 text-blue-700', due: this.getRelativeDate(-3), priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' },
      { id: 7, title: 'Ôn tập thuật toán', tag: 'Giải thuật', tagClass: 'bg-violet-100 text-violet-700', due: this.getRelativeDate(1), priority: 'Trung bình', pClass: 'bg-amber-100 text-amber-600' },
      { id: 8, title: 'Xây dựng Use Case Diagram', tag: 'PTPM', tagClass: 'bg-purple-100 text-purple-700', due: this.getRelativeDate(-1), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' }
    ];
  }

  private get defaultKanbanDone(): KanbanItem[] {
    return [
      { id: 9, title: 'Nộp bài tập tuần 1', tag: 'Cấu trúc dữ liệu', tagClass: 'bg-pink-100 text-pink-700', due: this.getRelativeDate(-10), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' },
      { id: 10, title: 'Làm slide bài thuyết trình', tag: 'Kỹ năng', tagClass: 'bg-indigo-100 text-indigo-700', due: this.getRelativeDate(-14), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' },
      { id: 11, title: 'Đọc chương 1-3 Clean Code', tag: 'Kỹ năng', tagClass: 'bg-indigo-100 text-indigo-700', due: this.getRelativeDate(-20), priority: 'Thấp', pClass: 'bg-emerald-100 text-emerald-600' }
    ];
  }

  aiSuggestions = [
    { rank: 1, title: 'Bài tập thiết kế CSDL', due: 'Quá hạn 3 ngày', dueClass: 'text-red-500 font-semibold', priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' },
    { rank: 2, title: 'Làm báo cáo UML', due: 'Còn 2 ngày', dueClass: 'text-orange-500 font-semibold', priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' },
    { rank: 3, title: 'Chuẩn bị thuyết trình', due: 'Còn 4 ngày', dueClass: 'text-amber-500 font-semibold', priority: 'Cao', pClass: 'bg-rose-100 text-rose-600' }
  ];

  deadlineAlerts = [
    { title: 'Bài tập thiết kế CSDL', due: 'Quá hạn 3 ngày', badge: 'Quá hạn', badgeClass: 'bg-rose-100 text-rose-600' },
    { title: 'Làm báo cáo UML', due: 'Còn 2 ngày', badge: 'Còn 2 ngày', badgeClass: 'bg-amber-100 text-amber-600' },
    { title: 'Chuẩn bị thuyết trình', due: 'Còn 4 ngày', badge: 'Còn 4 ngày', badgeClass: 'bg-orange-100 text-orange-600' }
  ];
  ...
  get overdueCount(): number { return this.tasks.filter(t => this.computeDueStatus(t).label === 'Quá hạn').length; }
  ...
  get filteredTasks(): TaskItem[] {
    ...
    return this.tasks.filter(task => {
      ...
      if (this.filterStatus && this.filterStatus !== 'all') {
        ...
        if (this.filterStatus === 'overdue' && task.status !== 'Quá hạn' && this.computeDueStatus(task).label !== 'Quá hạn') return false;
      }
  ...
  loadTasksFromApi() {
    ...
    this.taskService.getTasks({ pageSize: 50 }).pipe(take(1)).subscribe({
      ...
      error: (err) => {
        this.isLoading = false;
        console.warn('API getTasks failed or offline:', err);
        if (this.tasks.length === 0) {
          this.tasks = [...this.defaultMockTasks];
          this.recomputeAllDueStatuses();
          this.rebuildKanbanLists();
        }
      }
  ...
  private saveLocalTasks() {
    // Single Source of Truth: SQL Server DB via API
  }
  ...
  saveTag() {
    ...
    if (this.tagModalMode === 'create') {
      const newId = this.subjectTags.length > 0 ? Math.max(...this.subjectTags.map(t => t.id)) + 1 : 1;
      const newTag: SubjectTag = {
        id: newId,
        name: this.tagFormName.trim(),
        color: this.tagFormColor
      };
      this.subjectTags.push(newTag);
      // Auto-select tag into Môn học

  ...
  loadProfile() {
    ...
    this.authService.getProfile().subscribe({
      next: (profile: any) => {
        ...
        this.profileData = {
          ...profile,
          truongKhoa: profile.diaChi || localExt.truongKhoa || '',
          chuyenNganh: localExt.chuyenNganh || '',
        ...
        this.profileForm.patchValue({
          ...
          gioiTinh: this.profileData.gioiTinh ?? 0,
          truongKhoa: this.profileData.truongKhoa || '',
          chuyenNganh: this.profileData.chuyenNganh || ''
        });
        this.loading = false;
      ...
      error: (err) => {
        ...
        this.profileForm.patchValue({
          hoTen: this.profileData.hoTen || '',
          soDienThoai: this.profileData.soDienThoai || '',
          ngaySinh: this.profileData.ngaySinh || null,
          gioiTinh: this.profileData.gioiTinh ?? 0,
          truongKhoa: this.profileData.truongKhoa || '',
          chuyenNganh: this.profileData.chuyenNganh || ''
        });
